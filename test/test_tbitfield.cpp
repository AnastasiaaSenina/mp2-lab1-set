...
//янаярбеммше реярш
TEST(TBitField,can_double_cleaning_bit)
{
	TBitField bf(5);
...
TEST(TBitField, or_operator_applied_to_tree_bitfields_of_equal_size)
{
	const int size = 4;
...
TEST(TBitField, or_operator_applied_to_tree_bitfields_of_non_equal_size)
{
